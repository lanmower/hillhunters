...
class DeckEditor extends React.Component {
  ...
  render() {
    ...
    return (<form ref={form => (this.form = form)} style={containerstyle} onSubmit={event => event.preventDefault()}>
      ...
      <FormGroup style={formgroupstyle}>
        <FormLabel style={formlabelstyle}>Wheel Orientation</FormLabel>
      ...
      <FormGroup style={formgroupstyle}>
      <FormLabel style={formlabelstyle}>Wheel Hardness</FormLabel>
       <InputRange
        maxValue={110}
        minValue={65}
      ...
      <FormGroup style={formgroupstyle}>
      <FormLabel style={formlabelstyle}>Wheel Size</FormLabel>
       <InputRange
        maxValue={110}
        minValue={65}
