...
import TracksCollection from '../../../api/Tracks/Tracks';
import DecksCollection from '../../../api/Decks/Decks';
import {
  createContainer
}
...
class NewTrack extends React.Component {
  ...
  render() {
    ...
    return (
      this.state.tracking ? <div className="NewTrack"><AppBar position="static">
          <Toolbar>
